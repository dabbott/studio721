...
The advantage of this approach is speed, cost, and flexibility. As an example of
the additional flexibility, an API can return metadata for _any_ token id from 0
to infinity. This would be impossible with IPFS, since you could never upload
_infinity files_.
