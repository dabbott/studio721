...
The main thing to consider is whether you assets are _static_ or _dynamically
generated based on user input_.
...
- You can upload a file to IPFS as part of your minting site (this is what
